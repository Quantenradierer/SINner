        ...
        <div className="container">
            <Animator animator={{
                ...
                <div className='left-container'>
                    ...
                    <FramePentagon style={{margin: '5px', padding: '0px'}} squareSize={35}>
                        ...
                        <AttributeList attributes={relevantAttributesMain} firstColumnSize={120}/>
                    </FramePentagon>
                </div>
                <div className='attribute-cards-container'>
                    <div className={'two-cols'}>
                        <div className={'col1'}>
                            <AttributeCard title={i18next.t('npc_card_title_background')}
                                           attributes={['backstory', 'secret', 'experiences']}/>
                            <AttributeCard title={i18next.t('npc_card_title_social')}
                                           attributes={['family', 'contacts']}/>
                        </div>
                        <div className={'col2'}>
                            <AttributeCard title={i18next.t('npc_card_title_personality')}
                                           attributes={['quirks', 'motivations', 'resentments']}/>
                            <AttributeCard title={i18next.t('npc_card_title_skills_and_traits')}
                                           attributes={['strengths', 'weaknesses', 'hobbies_and_interests']}/>
                        </div>
                    </div>
                </div>
            </Animator>
