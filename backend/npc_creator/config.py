...
PROMPT = "Vervollständige einen Shadowrun NPC. {user_prompt}.\n" \
         "Die folgenden Punkte müssen ergänzt werden. Ignoriere beim Namen die Rasse und den Metatyp, aber achte auf die Ethnizität. Aber sei kreativ beim Namen. Antworte nur auf Deutsch.\n" \
         "{missing_attributes}\n" \
         "-----\n" \
