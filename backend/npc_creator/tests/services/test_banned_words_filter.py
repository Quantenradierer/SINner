...
class TestContainsBannedWord(unittest.TestCase):
    ...
    def test_no_banned_word(self, _mock_open):
        ...
        self.assertEqual("This message is free of any banned words", remove_banned_words(text))
    ...
    def test_banned_word_in_sentence(self, _mock_open):
        ...
        self.assertEqual('This message contains the word . However, there is a dot behind it.', remove_banned_words(text))
    ...
    def test_contains_banned_words_with_space(self, _mock_open):
        ...
        self.assertEqual('This message contains the word  and some other unrelated words.', remove_banned_words(text))
