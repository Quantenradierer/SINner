...
def find_correlated_response(responses: list[dict[str, Union[str, dict[str, Any]]]], search_text: str) -> Optional[str]:
    """
    Search for a response message in a list of messages based on the given search text.

    Parameters
    ----------
    responses : List[Dict[str, Union[str, Dict[str, Any]]]]
    ...
    -------
    Optional[str]
        The URL of the first message that matches the search criteria and contains a PNG attachment, or None if no match is found.
    """
